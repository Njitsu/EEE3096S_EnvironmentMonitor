...
def re(channel1):														#functions that are called when the event/interrupt occurs
    print("re")
...
try:                                          #try/except conditional for ADC data collection.Event additions can go above this i think
    while True:
